...
def _post_frame(url, frame, reset=False, preview=False):
...
def main():
    ...
    parser.add_argument("--host", default="192.168.55.2")
    ...
    reset_payload = _post_frame(url, reference, reset=True)
    shifted_payload = _post_frame(url, shifted, reset=False)
